...
class _EditYourVehicleScreenState extends State<EditYourVehicleScreen> {
  ...
  void _submitEditVehicle(BuildContext context) async {
    if (_vehicleNameController.text.isEmpty ||
      ...
      showFancyMessageToast(context, "Please fill all required fields");
      return;
    }
...
>>>>>>> Stashed changes
      ...
      showFancyErrorToast(context, "Failed to Edit Vehicle Details\nTry again");
  ...
  Widget build(BuildContext context) {
    ...
    final vehicle = provider.myVehicleDetail;
    final String ip = "https://backend.velocytax.in/";
...
Widget buildTextField(
  ...
  TextInputType keyboardType = TextInputType.text, // 👈 default is text
}) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
